...
interface AddProductModalProps {
  onClose: () => void;
  onAdd: (data: { name: string; price: number; categoryId?: number; imageUrl?: string }) => Promise<any>;
  onSuccess?: () => void;
  onError?: (error: string) => void;
  categories: { id: number; name: string }[];
}

export default function AddProductModal({ onClose, onAdd, onSuccess, onError, categories }: AddProductModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div className="flex-1">
              <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Product Photo</label>
              <input
                type="file"
                accept="image/*"
